...
app.get("/movie/get-movies", async (req, res) => {
  try {
    ...
    const client = new MongoClient("mongodb+srv://Dhivyaganapathi:Dhivyaganapathi@cluster0.ucefe.mongodb.net/?retryWrites=true&w=majority&appName=cluster0", {}).connect();
